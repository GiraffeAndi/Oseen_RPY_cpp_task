...
vtf_path = os.path.join(res_path, f"trajectory_force_z{sep}.vtf")
#json_path = os.path.join(res_path, f"trajectory_force_z{sep}.json")
...
part1 = system.part.add(pos = center + [0.0, 0.0, 0.0], type = 0, rotation=[True, True, True], ext_force=[0.0, 0.0, 1.0], dip=[-np.sqrt(3)/2, 0.5, 0.0])
part2 = system.part.add(pos = center + [sep, 0.0, 0.0], type = 0, rotation=[True, True, True], ext_force=[0.0, 0.0, 1.0], dip=[np.sqrt(3)/2, 0.5, 0.0])
part3 = system.part.add(pos = center + [sep/2, (np.sqrt(3)/2) * sep, 0], type = 0, rotation=[True, True, True], ext_force=[0.0, 0.0, 1.0], dip=[0.0, 1.0, 0.0])
