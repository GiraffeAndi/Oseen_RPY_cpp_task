...
part1 = system.part.add(pos = center + [0.0, 0.0, 0.0], type = 0)
part2 = system.part.add(pos = center + [sep, 0.0, 0.0], type = 0)
part3 = system.part.add(pos = center + [sep/2, (np.sqrt(3)/2) * sep, 0], type = 0, ext_force=[0.0, -6.0*np.pi, 0.0])
